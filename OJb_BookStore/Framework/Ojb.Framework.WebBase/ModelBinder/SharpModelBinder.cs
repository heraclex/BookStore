...
namespace Ojb.Framework.WebBase.ModelBinder
{
    using Ojb.Framework.Domain.Interfaces;

    public class OjbModelBinder : DefaultModelBinder
    {
        ...
        private static bool IsSimpleGenericBindableEntityCollection(Type propertyType) {
            var isSimpleGenericBindableCollection = propertyType.IsGenericType &&
                                                    (propertyType.GetGenericTypeDefinition() == typeof(IList<>) ||
                                                     ...
                                                     // propertyType.GetGenericTypeDefinition() == typeof(Iesi.Collections.Generic.ISet<>) || only need for NHibernate
